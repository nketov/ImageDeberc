...
public class FileBrowser
{
   ...
   // public GUISkin guiSkin; 
    ...
    public Texture2D fileTexture, directoryTexture, backTexture, driveTexture,directoryBack; //textures used to represent file types
    ...
    public string searchPattern = "*.jpg"; //search pattern used to find files
                                           //Output
